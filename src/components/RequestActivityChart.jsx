...
import { requestActivity } from '../data/mockData'
...
export default function RequestActivityChart() {
  ...
  return (
    <div className="glass-card p-6 relative overflow-hidden">
      ...
      <ResponsiveContainer width="100%" height={200}>
        <ComposedChart data={requestActivity} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
          {/* Gradient defs */}
          <defs>
